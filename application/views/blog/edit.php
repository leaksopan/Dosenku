        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('blog/view/' . $blog['id']) ?>"><?= $blog['judul'] ?></a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?= form_open_multipart('blog/edit/' . $blog['id']) ?>
                        <div class="mb-3">
                            <label class="form-label">Judul</label>
                            <input type="text" class="form-control" name="judul" value="<?= set_value('judul', $blog['judul']) ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Konten</label>
                            <textarea class="form-control" name="konten" id="editor" rows="10" required><?= set_value('konten', $blog['konten']) ?></textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?= base_url('blog/view/' . $blog['id']) ?>" class="btn btn-secondary">Batal</a>
